export default function defaultTheme(constant, settings) {
  const th = {
  ...
  return {
    ...
    menuFontWeight: th.fontWeightBorder,
    menuFg: th.colorFgText,
    menuBg: th.colorBg,
    menuActiveFg: th.colorFgHeading,
    menuActiveBg: th.colorBg,
    menuActiveFontWeight: th.fontWeightBold,
    menuSubmenuBg: th.colorBg,
    menuSubmenuFg: th.colorFgText,
    menuSubmenuActiveFg: th.colorFgHeading,
    menuSubmenuActiveBg: th.colorBg,
    ...
    tabsSelectedSecondColor: th.success,
