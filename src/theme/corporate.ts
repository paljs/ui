...
const corporate: Partial<ThemeObject> & { [key: string]: string } = {
  ...
  selectOutlinePrimaryOpenBorderColor: 'selectOptionsListOutlinePrimaryBorderColor',
  selectOutlineSuccessOpenBorderColor: 'selectOptionsListOutlineSuccessBorderColor',
  selectOutlineInfoOpenBorderColor: 'selectOptionsListOutlineInfoBorderColor',
  selectOutlineWarningOpenBorderColor: 'selectOptionsListOutlineWarningBorderColor',
  selectOutlineDangerOpenBorderColor: 'selectOptionsListOutlineDangerBorderColor',
  selectOutlineControlOpenBorderColor: 'selectOptionsListOutlineControlBorderColor',
};
