import { statusString, positionString } from '../shared';
...
export const userProps = [
  ...
  },
  {
    name: 'title',
    type: 'string',
    description: 'Specifies a title (written in a smaller font) to be shown under the name',
  },
  {
    name: 'onlyPicture',
    type: 'boolean',
    description: 'Whether to show only a picture or also show the name and title',
  },
  {
    name: 'image',
    type: 'string',
  ...
  },
  {
    name: 'showInitials',
    type: 'boolean',
    description: 'Whether to show a user initials (if no picture specified) or not',
  },
  {
    name: 'size',
    type: 'string',
    description: 'Size of the component available sizes: SM, MD, LG, XL default: MD',
  },
  {
    name: 'badge',
    type: 'object',
