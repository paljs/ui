...
export const chatProps = [
  {
    name: 'size',
    type: 'string',
    description: `Size of the component, ${sizeString} default: Medium`,
  },
  {
    name: 'status',
    type: 'string',
    description: `Field status (adds specific styles): ${statusString} default: Primary`,
  },
  {
    name: 'title',
    type: 'string',
...
export const messagesProps = [
  ...
  },
  {
    ...
    description: 'this props array contain object of all props under this line ↓',
  },
  {
    name: 'sender',
    type: 'string',
  ...
  },
  {
    name: 'files',
    type: 'array of file',
    description: 'this array of file object {url: `file url`, icon: `file icon class`, type: `type of file`}',
  },
  {
    name: 'quote',
    type: 'string',
...
export const fromProps = [
  {
    name: 'imgDropTypes',
    type: 'array',
    description: "array of available image type default: ['image/png', 'image/jpeg', 'image/gif']",
  },
  {
    name: 'message',
    type: 'string',
  ...
  },
  {
    ...
    type: 'string',
    description: 'when user try to drop file will see fileOverPlaceholder of input default: Drop file to send',
  },
  {
    name: 'filesIcon',
    type: 'string',
    description: 'image will see small preview but another file types need small icon you can send css class here',
  },
  {
    name: 'onSend()',
    type: 'function',
    description: 'Callback with data object { message: `text`, files: `array of files` }',
  },
];
