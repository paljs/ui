export const toastrProps = [
  ...
  },
  {
    ...
    type: 'string',
    description:
      'adds specific styles first letter capital: Primary, Info, Success, Warning, Danger, Default.'
  },
  {
    name: 'duration',
    type: 'number',
  ...
  },
  {
    ...
    type: 'boolean',
    description:
      'provides a capability to destroy toast by click. Default is true.'
  },
  {
  ...
  },
  {
    ...
    type: 'boolean',
    description:
      'if true then render toast icon. icon - you can pass icon class that will be applied into the toast.'
  },
  {
    name: 'icons',
    type: 'object',
