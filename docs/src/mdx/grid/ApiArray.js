...
export const row = [
  ...
  },
  {
    ...
    type: 'breakpoints',
    description:
      'add media with your value to use justify-content: space-around;.'
  },
  {
    name: 'between',
    type: 'breakpoints',
    description:
      'add media with your value to use justify-content: space-between.'
  }
];
...
export const col = [
  ...
  {
    name: 'xs, is, sm, md, lg, xl, xxl, xxxl',
    type: 'number | boolean',
    description: 'When number value, it specify the column size on the grid. (1 to 12), When true, enable auto sizing column. When false, hide colomn for the breakpoint.'
  },
  {
    name: 'xsOffset, isOffset, smOffset, mdOffset, lgOffset, xlOffset, xxlOffset, xxxlOffset',
    type: 'number',
    description: 'Offset the column (1-12)'
  },
];
