export const sidebarProps = [
  {
    name: 'state',
    type: 'string',
    description: 'Initial sidebar state, expanded | compacted | visible | hidden default: expanded',
  },
  {
    name: 'property',
    type: 'string',
    description: 'can be placed sidebar in right | left | start | end of layout default: start',
  },
  {
    name: 'fixed',
    type: 'boolean',
  ...
  },
  {
    name: 'responsive',
    type: 'boolean',
    description: 'Makes sidebar listen to media query events and change its behavior',
  },
  {
...
export const sidebarMethod = [
  {
    name: 'toggle()',
    type: 'Ref Method',
    description: 'change sidebar state if in expanded take to compacted if in hidden take to visible and opposite',
  },
  {
    name: 'hide()',
    type: 'Ref Method',
